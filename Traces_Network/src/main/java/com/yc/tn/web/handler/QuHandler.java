...
public class QuHandler {
	...
	@RequestMapping("/list")
	@ResponseBody
	private List<UserEntity> doList(){
	...
	@ResponseBody
	private List<UserEntity> doListTagByClick(){
	...
	@ResponseBody
	private List<UserEntity> doListAskBySt1(){
	...
	@ResponseBody
	private List<UserEntity> doListAskBySt2(){
	...
	@ResponseBody
	private List<UserEntity> doListAnswer(@RequestParam(name = "askId", required = false) String askId,HttpSession session){
	...
	@ResponseBody
	private List<UserEntity> doListAnswerContent(@RequestParam(name = "askId", required = false) String askId,HttpSession session){
