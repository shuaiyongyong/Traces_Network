...
public class Users {
	...
	public Users(int user_Id, String user_UserName, String user_UserPassword, String user_Sex, Date user_Date,
			String user_Pic, String user_Email, String user_Adress, String user_Phone,
	...
	public String toString() {
		return "Users [User_Id=" + User_Id + ", User_UserName=" + User_UserName + ", User_UserPassword="
				+ User_UserPassword + ", User_Sex=" + User_Sex + ", User_Date=" + User_Date + ", User_Pic=" + User_Pic
				+ ", User_Email=" + User_Email + ", User_Adress=" + User_Adress + ", User_Phone=" + User_Phone
