...
<body>
    ...
    <article>
    	<div class="article_top">
            ...
            <div class="article_top_right">
            	<div class="article_top_right_top">
                    ...
                    <li class="li2"><a href="#">只看该作者</a></li>
        ...
        <div class="article_bottom">
        	<div class="article_bottom_top">
            	<a href="#">上传图片请点击高级模式</a>
            </div>
            <div class="article_bottom_bottom">
            	<p>你需要登录后才可以回帖 <a href="login.jsp">登录</a> | <a href="#">注册</a></p>
            </div>
        </div>
    </article>
