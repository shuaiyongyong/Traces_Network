...
//		QuService qs = new QuServiceImpl();
		List<User> askList = quService.listAsk();
...
//		QuService qs = new QuServiceImpl();
		List<User> askList2 = quService.listAskByClick();
...
//		QuService qs = new QuServiceImpl();
		List<User> askList2 = quService.listAskBySt1();
		System.out.println(askList2);
		assertNotNull(askList2);
	}
...
//		QuService qs = new QuServiceImpl();
		List<User> answerList = quService.listAnswer("27");
...
//		QuService qs = new QuServiceImpl();
		List<User> contentList = quService.listAnswerContent("27");
